...
posts = Post.create([
    ...
    { title: "post2", content: "I am post2", user: users[1], comments_counter: 0, likes_counter: 0 },
    { title: "post3", content: "I am post3", user: users[2], comments_counter: 0, likes_counter: 0 },
    { title: "post4", content: "I am post4", user: users[3], comments_counter: 0, likes_counter: 0 },
    { title: "post5", content: "I am post5", user: users[4], comments_counter: 0, likes_counter: 0 }
])

comments = Comment.create([
    { content: "I am comment1", user: users[0], post: posts[0] },
    { content: "I am comment2", user: users[1], post: posts[1] },
    { content: "I am comment3", user: users[2], post: posts[2] },
    { content: "I am comment4", user: users[3], post: posts[3] },
    { content: "I am comment5", user: users[4], post: posts[4] }
])

likes = Like.create([
    { user: users[0], post: posts[0] },
    { user: users[1], post: posts[1] },
    { user: users[2], post: posts[2] },
    { user: users[3], post: posts[3] },
    { user: users[4], post: posts[4] }
])
